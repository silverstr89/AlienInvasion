...
func AlienDestroy(cities []st.City, aliens []st.Alien, c *(st.City), i int, community map[int]int) ([](st.City), []st.Alien) {
...
func CityDestroy(cities []st.City, aliens []st.Alien, r int, world map[string]int, cityGroup map[int]int, destroyedMap map[string]int, citiesWith1Alien []int) ([]st.City, []st.Alien, []int) {
